...
public class Util {
    ...
    public static String API_ONLINEKEY = "vNVEtiKTRz8a6PKnDf5oDWrxD1oV5cae";
    public static String API_ONLINESECRET = "GhmTrji4OJchlwQg0Z7hcqVsI_oOj7sP";
    public static String API_KEY = "vNVEtiKTRz8a6PKnDf5oDWrxD1oV5cae";
    public static String API_SECRET = "GhmTrji4OJchlwQg0Z7hcqVsI_oOj7sP";
